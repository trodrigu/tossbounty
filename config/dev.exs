...
config :tossbounty, Tossbounty.Repo,
  database: Path.expand("../tossbounty_dev.db", Path.dirname(__ENV__.file)),
  pool_size: 5,
  stacktrace: true,
...
config :tossbounty, TossbountyWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tossbounty_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :tossbounty, dev_routes: true
